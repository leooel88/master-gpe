;(function webpackUniversalModuleDefinition(root, factory) {
	...
	return /** ****/ (function () {
		...
		/** ****/ const __webpack_modules__ = {
			/***/ 482: /***/ function (
				...
				/* harmony import */ const _lib_event_js__WEBPACK_IMPORTED_MODULE_0__ =
					__webpack_require__(698)
				/* harmony import */ const _lib_date_format_js__WEBPACK_IMPORTED_MODULE_1__ =
					__webpack_require__(963)
				/* harmony import */ const _Datepicker_js__WEBPACK_IMPORTED_MODULE_2__ =
				...
				function setupDatepicker(rangepicker, changeDateListener, el, options) {
					;(0, _lib_event_js__WEBPACK_IMPORTED_MODULE_0__ /* .registerListeners */.cF)(
						rangepicker,
				...
				class DateRangePicker {
					...
					getDates(format = undefined) {
						const callback = format
							? (date) =>
									(0, _lib_date_format_js__WEBPACK_IMPORTED_MODULE_1__ /* .formatDate */.p6)(
										date,
										format,
			...
			/***/ 770: /***/ function (
				...
				const lib_date = __webpack_require__(560)
				// EXTERNAL MODULE: ./node_modules/flowbite-datepicker/js/lib/date-format.js
				const date_format = __webpack_require__(963)
				// EXTERNAL MODULE: ./node_modules/flowbite-datepicker/js/lib/event.js
				const lib_event = __webpack_require__(698) // CONCATENATED MODULE: ./node_modules/flowbite-datepicker/js/i18n/base-locales.js
				// default locales
				const locales = {
					en: {
				...
				function processOptions(options, datepicker) {
					const inOpts = { ...options }
					const config = {}
					const { locales } = datepicker.constructor
					let {
						format,
						language,
						locale,
  ...
  <div class="days-of-week grid grid-cols-7 mb-1">${(0, utils /* createTagRepeat */.em)('span', 7, {
		class:
			'dow block flex-1 leading-9 border-0 rounded-lg cursor-default text-center text-gray-900 font-semibold text-sm',
	})}</div>
  <div class="datepicker-grid w-64 grid grid-cols-7">${(0, utils /* createTagRepeat */.em)(
		'span',
		42,
		{
			class:
  ...
  <div class="weeks">${(0, utils /* createTagRepeat */.em)('span', 6, {
		class:
			'week block flex-1 leading-9 border-0 rounded-lg cursor-default text-center text-gray-900 font-semibold text-sm',
				...
				/* harmony default export */ const templates_calendarWeeksTemplate = calendarWeeksTemplate // CONCATENATED MODULE: ./node_modules/flowbite-datepicker/js/picker/views/View.js
					...
					init(options, onConstruction = true) {
						if (onConstruction) {
							...
							this.grid.appendChild(
								parseHTML(
									(0, utils /* createTagRepeat */.em)('span', 12, { 'data-month': (ix) => ix }),
								),
							)
						}
						super.init(options)
				...
				function computeResetViewDate(datepicker) {
					...
					const viewDate =
						dates.length > 0 ? (0, utils /* lastItemOf */.Jm)(dates) : config.defaultViewDate
				...
				class Picker {
					constructor(datepicker) {
						...
						elementClass === 'dropdown'
							? element.classList.add('dropdown', 'absolute', 'top-0', 'left-0', 'z-50', 'pt-2')
							: null
				...
				function moveByArrowKey(datepicker, ev, direction, vertical) {
					...
					switch (currentView.id) {
						...
						default:
							...
							testFn = (date) =>
								currentView.disabled.includes((0, lib_date /* startOfYearPeriod */.ak)(date, step))
					}
			...
			/***/ 963: /***/ function (
				...
				/* harmony import */ const _date_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(560)
				/* harmony import */ const _utils_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(105)
				...
				function parseFormatString(format) {
					...
					return (knownFormats[format] = {
						...
						formatter(date, locale) {
							...
							return (dateStr += (0, _utils_js__WEBPACK_IMPORTED_MODULE_1__ /* .lastItemOf */.Jm)(
								separators,
							))
						},
					})
				...
				function parseDate(dateStr, format, locale) {
					...
					if (format && format.toValue) {
						...
						return isNaN(date)
							? undefined
							: (0, _date_js__WEBPACK_IMPORTED_MODULE_0__ /* .stripTime */.xR)(date)
					}
			...
			/***/ 698: /***/ function (
				...
				function unregisterListeners(keyObj) {
					const listeners = listenerRegistry.get(keyObj)
					if (!listeners) {
						return
					}
					listeners.forEach((listener) => {
				...
				function findFromPath(path, criteria, currentTarget, index = 0) {
					...
					if (el === currentTarget || !el.parentElement) {
		...
		!(function () {
			...
			/* harmony import */ const flowbite_datepicker_Datepicker__WEBPACK_IMPORTED_MODULE_0__ =
				__webpack_require__(770)
			/* harmony import */ const flowbite_datepicker_DateRangePicker__WEBPACK_IMPORTED_MODULE_1__ =
				__webpack_require__(482)
			/* harmony import */ const _dom_events__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(947)
			...
			const events = new _dom_events__WEBPACK_IMPORTED_MODULE_2__['default']('DOMContentLoaded', [
				initDatepickers,
			])
			events.init()
		})()
