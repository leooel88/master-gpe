let containerDiv = document.getElementById('ficheposteread-div');
...
// LABEL
let labelModifierDiv = document.getElementById('modifier-label');
let labelModifierLink = document.getElementById('link-label');
// TYPE
let typeModifierDiv = document.getElementById('modifier-type');
let typeModifierLink = document.getElementById('link-type');
// URGENCY
let urgencyModifierDiv = document.getElementById('modifier-urgency');
let urgencyModifierLink = document.getElementById('link-urgency');
// JOBDESCRIPTION
let jobDescriptionModifierDiv = document.getElementById(
	'modifier-jobDescription'
);
let jobDescriptionModifierLink = document.getElementById('link-jobDescription');
// LOCALISATION
let localisationModifierDiv = document.getElementById('modifier-localisation');
let localisationModifierLink = document.getElementById('link-localisation');
//DESTINATIONSERVICE
let destinationServiceModifierDiv = document.getElementById(
	'modifier-destinationService'
);
let destinationServiceModifierLink = document.getElementById(
	'link-destinationService'
);
// ENTRYDATE
let entryDateModifierDiv = document.getElementById('modifier-entryDate');
let entryDateModifierLink = document.getElementById('link-entryDate');
// ENDDATE
let endDateModifierDiv = document.getElementById('modifier-endDate');
let endDateModifierLink = document.getElementById('link-endDate');
// EXPERIENCE
let experienceModifierDiv = document.getElementById('modifier-experience');
let experienceModifierLink = document.getElementById('link-experience');
// COMPENSATION
let compensationModifierDiv = document.getElementById('modifier-compensation');
let compensationModifierLink = document.getElementById('link-compensation');
...
urgencyModifierLink.addEventListener('click', () =>
	handleLinkClicked('urgency')
);
jobDescriptionModifierLink.addEventListener('click', () =>
	handleLinkClicked('jobDescription')
);
localisationModifierLink.addEventListener('click', () =>
	handleLinkClicked('localisation')
);
destinationServiceModifierLink.addEventListener('click', () =>
	handleLinkClicked('destinationService')
);
entryDateModifierLink.addEventListener('click', () =>
	handleLinkClicked('entryDate')
);
endDateModifierLink.addEventListener('click', () =>
	handleLinkClicked('endDate')
);
experienceModifierLink.addEventListener('click', () =>
	handleLinkClicked('experience')
);
compensationModifierLink.addEventListener('click', () =>
	handleLinkClicked('compensation')
);
...
function handleUpdateClicked() {
	...
	let currentForm = document
		.querySelector('#form-update-' + currentUpdate)
		.submit();
}
